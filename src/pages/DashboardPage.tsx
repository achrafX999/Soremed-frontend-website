...
const DashboardPage: React.FC = () => {
  ...
  const stats = [
    { title: 'Total Orders', value: '700', icon: Package2, color: 'bg-blue-500' },
    { title: 'Monthly Growth', value: '+12.5%', icon: TrendingUp, color: 'bg-green-500' },
    { title: 'Pending Orders', value: '23', icon: Clock, color: 'bg-yellow-500' },
